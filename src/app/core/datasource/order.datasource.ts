...
import { Orders } from "../interfaces/caffe_interace";
import { QueryResultsModel } from "../models/query-models/query-results.model";
import { CaffeServices } from "../services/caffe.services";

export class OrderDataSource implements DataSource<Orders> {

    entitySubject = new BehaviorSubject<Orders[]>([]);
    ...
    getOrders() {
        return this.caffeServices.getOrders().pipe(
            tap((response: any) => {
